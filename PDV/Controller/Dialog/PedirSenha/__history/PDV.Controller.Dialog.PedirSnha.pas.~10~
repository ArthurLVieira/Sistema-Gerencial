...
function TControllerDialogPedirSenha.ButtonCancel(
  Value: TNotifyEvent): iControllerDialogPedirSenha;
begin

end;

function TControllerDialogPedirSenha.ButtonConfirm(
  Value: TNotifyEvent): iControllerDialogPedirSenha;
begin
...
function TControllerDialogPedirSenha.TextCancel(
  Value: string): iControllerDialogPedirSenha;
begin

end;

function TControllerDialogPedirSenha.TextConfirm(
  Value: string): iControllerDialogPedirSenha;
begin

end;

function TControllerDialogPedirSenha.TextConfirmSenha(
  Value: string): iControllerDialogPedirSenha;
begin

end;

function TControllerDialogPedirSenha.Title(
  Value: string): iControllerDialogPedirSenha;
begin

end;

function TControllerDialogPedirSenha.VisibleImage(
  Value: Double): iControllerDialogPedirSenha;
begin

end;

function TControllerDialogPedirSenha.VisibleTextConfirmSenha(
  Value: Boolean): iControllerDialogPedirSenha;
begin
