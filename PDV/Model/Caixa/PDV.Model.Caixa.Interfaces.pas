...
type
  ...
  iModelCaixaMetodosAbertura = interface
    ...
    function SetOperadorAbertura(Value: iModelUsuario): iModelCaixaMetodosAbertura;
  ...
  iModelCaixaMetodosFechamento = interface
    ...
    function SetOperadorFechamento(Value: iModelUsuario): iModelCaixaMetodosFechamento;
    function &End: iModelCaixaMetodos;
  end;
